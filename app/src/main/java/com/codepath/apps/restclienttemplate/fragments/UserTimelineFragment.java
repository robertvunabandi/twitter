...
/**
 * Created by robertvunabandi on 7/4/17.
 */
...
public class UserTimelineFragment extends TweetsListFragment {
    ...
    public void populateTimeline(int count) {
        ...
        client.getUserTimeline(getArguments().getString("screen_name"), count, new JsonHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                ...
                addItems(response, false); // we don't know follow ourselves
            }
            @Override
    ...
    public void addToTimeline() {
        ...
        client.addToUserTimeline(getArguments().getString("screen_name"), max_id, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                addItems(response, false); // we don't know follow ourselves
                ...
                Log.d(TAG, String.format("tweet size: %s, and maxid: %s, PopulateTimeline User at %s", totalTweets, max_id, HMS.format(CAL.getTime())));
            }
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(client.TAG, response.toString());
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Log.e(client.TAG, errorResponse.toString() + "Damn 1");
                throwable.printStackTrace();
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                Log.e(client.TAG, errorResponse.toString() + "Damn 2");
                throwable.printStackTrace();
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                Log.e(client.TAG, responseString + "Damn 3");
                throwable.printStackTrace();
